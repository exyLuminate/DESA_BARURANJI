...
import { InputNumber, Button, Alert, Popconfirm } from 'antd';
import { 
    SaveOutlined, ArrowLeftOutlined, CalendarOutlined, 
    TeamOutlined, EnvironmentOutlined, HeartOutlined, 
    ManOutlined, WomanOutlined, HomeOutlined, DeleteOutlined
...
export default function Edit({ statistic }) {
    ...
    const handleDelete = () => {
        destroy(route('admin.village-statistics.destroy', statistic.id));
    };
            ...
            <div className="max-w-7xl mx-auto pb-10">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold text-gray-800">Edit Statistik Desa</h1>
                    </div>
                </div>

                {isHistoricalData && (
                    <Alert 
                        message="Perhatian: Mengedit Data Historis" 
                        description={`Anda sedang mengedit data statistik untuk tahun ${data.statistic_year}, yang merupakan data masa lalu. Pastikan perubahan ini memang diperlukan untuk koreksi arsip.`} 
                        type="warning" 
                        showIcon 
                        className="mb-6 rounded-2xl border-yellow-200 bg-yellow-50"
                    />
                )}
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl shadow-sm border border-blue-100 p-6 flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-sm text-gray-500">Ubah tahun dengan hati-hati untuk menghindari duplikasi data tahunan.</p>
                        </div>
                ...
                {/* Danger Zone (Hapus Cepat) */}
                <div className="mt-8 bg-red-50/50 border border-red-100 rounded-3xl p-8 max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        ...
                        <Popconfirm
                            ...
                            description="Tindakan ini tidak dapat dibatalkan (permanen)."
