        ...
        <AdminLayout>
            ...
            <div className="py-6 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 sm:gap-0">
                    <h1 className="text-2xl font-semibold text-gray-800">Edit Perangkat Desa</h1>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" value={data.position} onChange={e => setData('position', e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500 sm:text-sm" required />
