...
export default function Edit({ auth, banner }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        image: null, // Dikosongkan agar hanya terkirim jika diubah
        button_text: banner.button_text || '',
        button_url: banner.button_url || '',
        sort_order: banner.sort_order || 0,
        is_active: banner.is_active,
        _method: 'put', // Laravel requirement for multipart form-data on updates
    });
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Banner</h2>}
        >
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <form onSubmit={submit} encType="multipart/form-data">
                            ...
                            <div className="mb-4">
                                ...
                                {banner.image && (
                                    <div className="mb-2">
                                        <img src={`/storage/${banner.image}`} alt="Current Banner" className="w-64 h-32 object-cover rounded shadow" />
                                    </div>
                                )}
                                <input 
                                    type="file" 
                                ...
                                <p className="text-xs text-gray-500 mt-1">Kosongkan jika tidak ingin mengubah gambar. Format: JPG, JPEG, PNG, WEBP (Maks 2MB).</p>
                            </div>
