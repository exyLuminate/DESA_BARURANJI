...
export default function Gallery({ categories = [], galleries = { data: [], links: [] }, currentCategory = 'semua' }) {
    ...
    return (
        // Gunakan PublicLayout sebagai wrapper utama
        <PublicLayout>
                        ...
                        <Image.PreviewGroup>
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                                {galleries.data.map((item) => (
                                    <div key={item.id} className="group flex flex-col bg-gray-50 rounded-xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
